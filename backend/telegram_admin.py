...
def get_main_menu_keyboard():
    ...
    keyboard = [
        [InlineKeyboardButton("🌐 Открыть сайт", web_app=WebAppInfo(url="https://2f73ccd4-1138-4101-9eaa-0c84c1b33da1.preview.emergentagent.com"))],
...
🌐 Перейдите в наш каталог для выбора и заказа товаров:
    ...
    keyboard = [
        [InlineKeyboardButton("🌐 Открыть каталог", web_app=WebAppInfo(url="https://2f73ccd4-1138-4101-9eaa-0c84c1b33da1.preview.emergentagent.com"))],
